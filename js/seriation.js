...
var real__computeIntervalProximity = asm["_computeIntervalProximity"];
asm["_computeIntervalProximity"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__computeIntervalProximity.apply(null, arguments);
};
...
var _computeIntervalProximity = Module["_computeIntervalProximity"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_computeIntervalProximity"].apply(null, arguments)
};
