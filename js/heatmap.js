    ...
    d3.text(url).then(function(textString) {
        ...
        for( i=0 ;i< row_number; i++)
        {
            ...
            for( j=0 ;j< col_number; j++ )
            {
                ...
                tempdata.push(dataset[i+xCov][dataset.columns[j+yCov+yN]]);
            } 
            data.push(tempdata);  
        }
        ...
        for( i=0 ;i< row_number; i++)
        {
            ...
            {
                //tempdata.push(Number(dataset[i+xCov][dataset.columns[j+yCov+yN]]));
                var temp_interval_minmax = data[i][j].split(',');
                tempmindata.push(Number(temp_interval_minmax[0]));
                tempmaxdata.push(Number(temp_interval_minmax[1]));
            } 
            interval_min.push(tempmindata);  
            interval_max.push(tempmaxdata);  
        }

        max_value = d3.max(interval_max, function(row) { return d3.max(row) });
        min_value = d3.min(interval_min, function(row) { return d3.min(row) });
        ...
        for( j=0 ;j< col_number; j++)
        {
            data_max_value[j]=interval_max[0][j];
            data_min_value[j]=interval_min[0][j];
            for( i=0 ;i< row_number; i++)
            {
                if(data_max_value[j]<interval_max[i][j])
                {
                    data_max_value[j]=interval_max[i][j];   
                }
                if(data_min_value[j]>interval_min[i][j])
                {
                    data_min_value[j]=interval_min[i][j];   
                }
            }
        }
        ...
        for( i=0 ;i< row_number; i++)
        {
            data_row_max_value[i]=interval_max[i][0];
            data_row_min_value[i]=interval_min[i][0];
            for( j=0 ;j< col_number; j++)
            {
                if(data_row_max_value[i]<interval_max[i][j])
                {
                    data_row_max_value[i]=interval_max[i][j];   
                }
                if(data_row_min_value[i]>interval_min[i][j])
                {
                    data_row_min_value[i]=interval_min[i][j];   
                }
            }
        }
        ...
        var x_ratio = Math.ceil(viewerWidth/(col_number+row_number));
        var y_ratio = Math.ceil((viewerHeight-250)/(col_number+row_number));
...
*/
        ...
        d3.select("#rowprox").on("change", function() { 
          /*  rowProxData = new Array(row_number);
            ...
            else if (this.value == "hausdorff"){
                var rowProxData1D = runIntervalProximity(0, 0, 0);
            ...
            else if (this.value == "euclidean_hausdorff"){
                var rowProxData1D = runIntervalProximity(1, 0, 0);
            ...
            else if (this.value == "normalized_euclidean_hausdorff"){
                var rowProxData1D = runIntervalProximity(2, 0, 0);
            ...
            else if (this.value == "span_normalized_euclidean_hausdorff"){
                var rowProxData1D = runIntervalProximity(3, 0, 0);
            ...
            else if (this.value == "gowda_diday"){
                var rowProxData1D = runIntervalProximity(4, 0, 0);
            ...
            else if (this.value == "generality_degree"){
                var rowProxData1D = runIntervalProximity(5, 0, 0);
            ...
            else if (this.value == "l1_interval"){
                var rowProxData1D = runIntervalProximity(6, 0, 0);
            ...
            else if (this.value == "l2_interval"){
                var rowProxData1D = runIntervalProximity(7, 0, 0);
            ...
            else if (this.value == "city_block_interval"){
                var rowProxData1D = runIntervalProximity(8, 0, 0);
        ...
        d3.select("#colprox").on("change", function() { 
            ...
            */
            ...
            else if (this.value == "empirical_correlation"){
                var colProxData1D = runIntervalProximity(9, 1, 0);
